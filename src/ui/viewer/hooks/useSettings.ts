    ...
    authFetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        ...
        setSettings({
          ...
          CLAUDE_MEM_CUSTOM_API_URL: data.CLAUDE_MEM_CUSTOM_API_URL ?? DEFAULT_SETTINGS.CLAUDE_MEM_CUSTOM_API_URL,
          ...
          CLAUDE_MEM_CUSTOM_PROTOCOL: data.CLAUDE_MEM_CUSTOM_PROTOCOL ?? DEFAULT_SETTINGS.CLAUDE_MEM_CUSTOM_PROTOCOL,
          CLAUDE_MEM_CUSTOM_STREAMING: data.CLAUDE_MEM_CUSTOM_STREAMING ?? DEFAULT_SETTINGS.CLAUDE_MEM_CUSTOM_STREAMING,
          ...
          CLAUDE_MEM_CUSTOM_FIRST_TOKEN_TIMEOUT: data.CLAUDE_MEM_CUSTOM_FIRST_TOKEN_TIMEOUT ?? DEFAULT_SETTINGS.CLAUDE_MEM_CUSTOM_FIRST_TOKEN_TIMEOUT,
          CLAUDE_MEM_CUSTOM_TOTAL_TIMEOUT: data.CLAUDE_MEM_CUSTOM_TOTAL_TIMEOUT ?? DEFAULT_SETTINGS.CLAUDE_MEM_CUSTOM_TOTAL_TIMEOUT,
