"use strict";var vt=Object.create;var j=Object.defineProperty;var yt=Object.getOwnPropertyDescriptor;var Ut=Object.getOwnPropertyNames;var xt=Object.getPrototypeOf,wt=Object.prototype.hasOwnProperty;var kt=(r,e)=>{for(var t in e)j(r,t,{get:e[t],enumerable:!0})},he=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ut(e))!wt.call(r,n)&&n!==t&&j(r,n,{get:()=>e[n],enumerable:!(s=yt(e,n))||s.enumerable});return r};var U=(r,e,t)=>(t=r!=null?vt(xt(r)):{},he(e||!r||!r.__esModule?j(t,"default",{value:r,enumerable:!0}):t,r)),Ft=r=>he(j({},"__esModule",{value:!0}),r);var ms={};kt(ms,{generateContext:()=>Oe});module.exports=Ft(ms);var It=U(require("path"),1),Lt=require("os"),Mt=require("fs");var de=require("bun:sqlite");var p=require("path"),ne=require("os"),D=require("fs");var M=require("fs"),Ae=require("path");var Pt=null;function $t(r){return(Pt??process.stderr.write.bind(process.stderr))(r)}function te(r){$t(r)}var se=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(se||{}),re=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,M.existsSync)(e)||(0,M.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ae.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,M.existsSync)(e)){let t=(0,M.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=se[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=se[e].padEnd(5),d=t.padEnd(6),m="";n?.correlationId?m=`[${n.correlationId}] `:n?.sessionId&&(m=`[session-${n.sessionId}] `);let c="";if(o!=null)if(o instanceof Error)c=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{c=`
`+JSON.stringify(o,null,2)}catch{c=" "+this.formatData(o)}else c=" "+this.formatData(o);let g="";if(n){let{sessionId:l,memorySessionId:f,correlationId:O,...S}=n;Object.keys(S).length>0&&(g=` {${Object.entries(S).map(([b,T])=>`${b}=${T}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${m}${s}${g}${c}`;if(this.logFilePath)try{(0,M.appendFileSync)(this.logFilePath,E+`
`,"utf8")}catch(l){te(`[LOGGER] Failed to write to log file: ${l instanceof Error?l.message:String(l)}
`)}else te(E+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}error(e,t,s,n){this.log(3,e,t,s,n)}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}timing(e,t,s,n){this.info(e,`\u23F1 ${t}`,n,{duration:`${s}ms`})}happyPathError(e,t,s,n,o=""){let m=((new Error().stack||"").split(`
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),c=m?`${m[1].split("/").pop()}:${m[2]}`:"unknown",g={...s,location:c};return this.warn(e,`[HAPPY-PATH] ${t}`,g,n),o}},u=new re;function Ht(){let r=process.argv[1];return r?(0,p.dirname)(r):process.cwd()}function Gt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,p.join)((0,ne.homedir)(),".claude-mem"),e=(0,p.join)(r,"settings.json");try{if((0,D.existsSync)(e)){let t=JSON.parse((0,D.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var A=Gt(),v=process.env.CLAUDE_CONFIG_DIR||(0,p.join)((0,ne.homedir)(),".claude"),bs=(0,p.join)(v,"plugins","marketplaces","thedotmack"),Xt=(0,p.join)(A,"archives"),jt=(0,p.join)(A,"logs"),Bt=(0,p.join)(A,"trash"),Wt=(0,p.join)(A,"backups"),Vt=(0,p.join)(A,"modes"),Os=(0,p.join)(A,"settings.json"),Re=(0,p.join)(A,"claude-mem.db"),qt=(0,p.join)(A,"vector-db"),Ce=(0,p.join)(A,"observer-sessions"),oe=(0,p.basename)(Ce),hs=(0,p.join)(v,"settings.json"),As=(0,p.join)(v,"commands"),Rs=(0,p.join)(v,"CLAUDE.md");function Ne(r){(0,D.mkdirSync)(r,{recursive:!0})}function Ie(){return(0,p.join)(Ht(),"..")}var x={dataDir:()=>A,workerPid:()=>(0,p.join)(A,"worker.pid"),serverBetaPid:()=>(0,p.join)(A,".server-beta.pid"),serverBetaPort:()=>(0,p.join)(A,".server-beta.port"),serverBetaRuntime:()=>(0,p.join)(A,".server-beta.runtime.json"),settings:()=>(0,p.join)(A,"settings.json"),database:()=>(0,p.join)(A,"claude-mem.db"),chroma:()=>(0,p.join)(A,"chroma"),combinedCerts:()=>(0,p.join)(A,"combined_certs.pem"),transcriptsConfig:()=>(0,p.join)(A,"transcript-watch.json"),transcriptsState:()=>(0,p.join)(A,"transcript-watch-state.json"),corpora:()=>(0,p.join)(A,"corpora"),supervisorRegistry:()=>(0,p.join)(A,"supervisor.json"),envFile:()=>(0,p.join)(A,".env"),logsDir:()=>jt,archives:()=>Xt,trash:()=>Bt,backups:()=>Wt,modes:()=>Vt,vectorDb:()=>qt,observerSessions:()=>Ce};var Ue=require("crypto");var Me=require("os"),De=U(require("path"),1),ve=require("child_process");var W=require("fs"),B=U(require("path"),1);var w={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Le(r){let e=B.default.join(r,".git"),t;try{t=(0,W.statSync)(e)}catch(c){return c instanceof Error&&c.code!=="ENOENT"&&u.warn("GIT","Unexpected error checking .git",{error:c instanceof Error?c.message:String(c)}),w}if(!t.isFile())return w;let s;try{s=(0,W.readFileSync)(e,"utf-8").trim()}catch(c){return u.warn("GIT","Failed to read .git file",{error:c instanceof Error?c.message:String(c)}),w}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return w;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return w;let a=i[1],d=B.default.basename(r),m=B.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:m}}function ye(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,Me.homedir)()):r}function Kt(r){try{return(0,ve.execFileSync)("git",["rev-parse","--show-toplevel"],{cwd:r,encoding:"utf-8",stdio:["ignore","pipe","ignore"]}).trim()||null}catch{return null}}function Yt(r){if(!r||r.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=ye(r),s=Kt(e)??e,n=De.default.basename(s);if(n===""){if(process.platform==="win32"){let i=r.match(/^([A-Z]):\\/i);if(i){let d=`drive-${i[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:d}),d}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return n}function ie(r){let e=Yt(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=ye(r),s=Le(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function V(r,e,t){return(0,Ue.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ae(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var C="claude";function Jt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return C;let e=Jt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:C}function xe(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Qt(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var q=class{db;constructor(e=Re){e instanceof de.Database?this.db=e:(e!==":memory:"&&Ne(A),this.db=new de.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.ensureDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn()}ensureDeadPendingMessagesColumns(){let e=this.db.query("PRAGMA table_info(pending_messages)").all(),t=new Set(e.map(n=>n.name)),s=[{name:"retry_count",ddl:"ALTER TABLE pending_messages ADD COLUMN retry_count INTEGER NOT NULL DEFAULT 0"},{name:"failed_at_epoch",ddl:"ALTER TABLE pending_messages ADD COLUMN failed_at_epoch INTEGER"},{name:"completed_at_epoch",ddl:"ALTER TABLE pending_messages ADD COLUMN completed_at_epoch INTEGER"}];for(let{name:n,ddl:o}of s)if(!t.has(n))try{this.db.run(o),u.debug("DB",`Restored ${n} column on pending_messages`)}catch(i){u.warn("DB",`Failed to restore ${n} column on pending_messages`,{},i instanceof Error?i:new Error(String(i)))}}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,m=s==="relevance",c=m?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,g=n?`LIMIT ${n}`:"",E=e.map(()=>"?").join(","),l=[...e],f=[];if(o&&(f.push("project = ?"),l.push(o)),i)if(Array.isArray(i)){let T=i.map(()=>"?").join(",");f.push(`type IN (${T})`),l.push(...i)}else f.push("type = ?"),l.push(i);if(a){let T=Array.isArray(a)?a:[a],R=T.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");l.push(...T),f.push(`(${R.join(" OR ")})`)}if(d){let T=Array.isArray(d)?d:[d],R=T.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");T.forEach(L=>{l.push(`%${L}%`,`%${L}%`)}),f.push(`(${R.join(" OR ")})`)}let O=f.length>0?`WHERE id IN (${E}) AND ${f.join(" AND ")}`:`WHERE id IN (${E})`,h=this.db.prepare(`
      SELECT *
      FROM observations
      ${O}
      ${c}
      ${g}
    `).all(...l);if(!m)return h;let b=new Map(h.map(T=>[T.id,T]));return e.map(T=>b.get(T)).filter(T=>!!T)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),m=new Date(d).toISOString(),c=V(e,s.title,s.narrative),E=this.db.prepare(`
    ...
    `).get(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,c,m,d,a||null,s.metadata??null);if(E)return{id:E.id,createdAtEpoch:E.created_at_epoch};let l=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,c);if(!l)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${c}`);return{id:l.id,createdAtEpoch:l.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),c=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(c.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let m=a??Date.now(),c=new Date(m).toISOString();return this.db.transaction(()=>{let E=[],l=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),f=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let h of s){let b=V(e,h.title,h.narrative),T=l.get(e,t,h.type,h.title,h.subtitle,JSON.stringify(h.facts),h.narrative,JSON.stringify(h.concepts),JSON.stringify(h.files_read),JSON.stringify(h.files_modified),o||null,i,h.agent_type??null,h.agent_id??null,b,c,m,d||null);if(T){E.push(T.id);continue}let R=f.get(e,b);if(!R)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${b}`);E.push(R.id)}let O=null,S=null;if(n){let h=this.db.prepare(`
          SELECT MAX(created_at_epoch) as max_epoch
          FROM observations WHERE memory_session_id = ?
        `).get(e);S=Math.max(m,(h?.max_epoch??0)+1);let b=new Date(S).toISOString(),R=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,b,S);O=Number(R.lastInsertRowid)}return{observationIds:E,summaryId:O,createdAtEpoch:m}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,m,c){let g=m??Date.now(),E=new Date(g).toISOString();return this.db.transaction(()=>{let f=[],O=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let R of s){let L=V(e,R.title,R.narrative),X=O.get(e,t,R.type,R.title,R.subtitle,JSON.stringify(R.facts),R.narrative,JSON.stringify(R.concepts),JSON.stringify(R.files_read),JSON.stringify(R.files_modified),a||null,d,R.agent_type??null,R.agent_id??null,L,E,g,c||null);if(X){f.push(X.id);continue}let ee=S.get(e,L);if(!ee)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${L}`);f.push(ee.id)}let h;if(n){let R=this.db.prepare(`
          SELECT MAX(created_at_epoch) as max_epoch
          FROM observations WHERE memory_session_id = ?
        `).get(e),L=Math.max(g,(R?.max_epoch??0)+1),X=new Date(L).toISOString(),Dt=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,X,L);h=Number(Dt.lastInsertRowid)}if(this.db.prepare(`
        DELETE FROM pending_messages
        WHERE id = ? AND status = 'processing'
      `).run(o).changes!==1)throw new Error(`storeObservationsAndMarkComplete: failed to complete pending message ${o}`);return{observationIds:f,summaryId:h,createdAtEpoch:g}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),c=[...e],g=o?`WHERE id IN (${m}) AND project = ?`:`WHERE id IN (${m})`;o&&c.push(o);let l=this.db.prepare(`
      SELECT * FROM session_summaries
      ${g}
      ${a}
      ${d}
    `).all(...c);if(!i)return l;let f=new Map(l.map(O=>[O.id,O]));return e.map(O=>f.get(O)).filter(O=>!!O)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),c=[...e],g=o?"AND s.project = ?":"";o&&c.push(o);let l=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(...c);if(!i)return l;let f=new Map(l.map(O=>[O.id,O]));return e.map(O=>f.get(O)).filter(O=>!!O)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,m;if(e!==null){let S=`
...
`}function Tt(r,e,t,s){let n=[];return s?n.push(...nt(r)):n.push(...Be(r)),s?n.push(...ot()):n.push(...We()),s?n.push(...it()):n.push(...Ve()),s?n.push(...at()):n.push(...qe()),Y(t)&&(s?n.push(...dt(e,t)):n.push(...Ke(e,t))),n}var fe=U(require("path"),1);function Z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Se(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function be(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function St(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ft(r,e){return fe.default.isAbsolute(r)?fe.default.relative(e,r):r}function bt(r,e,t){let s=Z(r);if(s.length>0)return ft(s[0],e);if(t){let n=Z(t);if(n.length>0)return ft(n[0],e)}return"General"}function ns(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=St(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Ot(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Z(r.facts).join(`
`):null}function os(r,e,t,s){let n=[];n.push(...Ye(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Se(a.displayTime);n.push(...Ze(a,d))}else{let a=i.data,d=be(a.created_at),c=d!==o?d:"";if(o=d,t.has(a.id)){let E=Ot(a,s);n.push(...ze(a,c,E,s))}else n.push(Qe(a,c,s))}return n}function is(r,e,t,s,n){let o=[];o.push(..._t(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let m=d.data,c=Se(m.displayTime);o.push(...lt(m,c))}else{let m=d.data,c=bt(m.files_modified,n,m.files_read),g=be(m.created_at),E=g!==a;a=g;let l=t.has(m.id);if(c!==i&&(o.push(...ut(c)),i=c),l){let f=Ot(m,s);o.push(...mt(m,g,E,f,s))}else o.push(ct(m,g,E,s))}return o.push(""),o}function as(r,e,t,s,n,o){return o?is(r,e,t,s,n):os(r,e,t,s)}function ht(r,e,t,s,n){let o=[],i=ns(r);for(let[a,d]of i)o.push(...as(a,d,e,t,s,n));return o}function At(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Rt(r,e){let t=[];return e?(t.push(...G("Investigated",r.investigated,_.blue)),t.push(...G("Learned",r.learned,_.yellow)),t.push(...G("Completed",r.completed,_.green)),t.push(...G("Next Steps",r.next_steps,_.magenta))):(t.push(...H("Investigated",r.investigated)),t.push(...H("Learned",r.learned)),t.push(...H("Completed",r.completed)),t.push(...H("Next Steps",r.next_steps))),t}function Ct(r,e){return e?Et(r):et(r)}function Nt(r,e,t){return!Y(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?pt(r.totalDiscoveryTokens,r.totalReadTokens):tt(r.totalDiscoveryTokens,r.totalReadTokens)}var ds=It.default.join((0,Lt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function _s(){try{return new q}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Mt.unlinkSync)(ds)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function us(r,e){return e?gt(r):st(r)}function cs(r,e,t,s,n,o,i){let a=[],d=le(e);a.push(...Tt(r,d,s,i));let m=t.slice(0,s.sessionCount),c=Ge(m,t),g=Te(e,c),E=Xe(e,s.fullObservationCount);a.push(...ht(g,E,s,n,i));let l=t[0],f=e[0];At(s,l,f)&&a.push(...Rt(l,i));let O=ge(e,s,o,n);return a.push(...Ct(O,i)),a.push(...Nt(d,s,i)),a.join(`
