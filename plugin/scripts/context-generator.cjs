"use strict";var vt=Object.create;var X=Object.defineProperty;var Ut=Object.getOwnPropertyDescriptor;var xt=Object.getOwnPropertyNames;var wt=Object.getPrototypeOf,kt=Object.prototype.hasOwnProperty;var Pt=(r,e)=>{for(var t in e)X(r,t,{get:e[t],enumerable:!0})},Re=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of xt(e))!kt.call(r,n)&&n!==t&&X(r,n,{get:()=>e[n],enumerable:!(s=Ut(e,n))||s.enumerable});return r};var U=(r,e,t)=>(t=r!=null?vt(wt(r)):{},Re(e||!r||!r.__esModule?X(t,"default",{value:r,enumerable:!0}):t,r)),Ft=r=>Re(X({},"__esModule",{value:!0}),r);var ms={};Pt(ms,{generateContext:()=>Oe});module.exports=Ft(ms);var Lt=U(require("path"),1),Mt=require("os"),Dt=require("fs");var de=require("bun:sqlite");var E=require("path"),ne=require("os"),D=require("fs");var M=require("fs"),he=require("path");var $t=null;function Ht(r){return($t??process.stderr.write.bind(process.stderr))(r)}function te(r){Ht(r)}var se=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(se||{}),re=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,M.existsSync)(e)||(0,M.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,he.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,M.existsSync)(e)){let t=(0,M.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=se[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=se[e].padEnd(5),d=t.padEnd(6),p="";n?.correlationId?p=`[${n.correlationId}] `:n?.sessionId&&(p=`[session-${n.sessionId}] `);let c="";if(o!=null)if(o instanceof Error)c=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{c=`
`+JSON.stringify(o,null,2)}catch{c=" "+this.formatData(o)}else c=" "+this.formatData(o);let g="";if(n){let{sessionId:m,memorySessionId:f,correlationId:O,...S}=n;Object.keys(S).length>0&&(g=` {${Object.entries(S).map(([b,T])=>`${b}=${T}`).join(", ")}}`)}let l=`[${i}] [${a}] [${d}] ${p}${s}${g}${c}`;if(this.logFilePath)try{(0,M.appendFileSync)(this.logFilePath,l+`
`,"utf8")}catch(m){te(`[LOGGER] Failed to write to log file: ${m instanceof Error?m.message:String(m)}
`)}else te(l+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}error(e,t,s,n){this.log(3,e,t,s,n)}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}timing(e,t,s,n){this.info(e,`\u23F1 ${t}`,n,{duration:`${s}ms`})}happyPathError(e,t,s,n,o=""){let p=((new Error().stack||"").split(`
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),c=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",g={...s,location:c};return this.warn(e,`[HAPPY-PATH] ${t}`,g,n),o}},u=new re;function Gt(){let r=process.argv[1];return r?(0,E.dirname)(r):process.cwd()}function jt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,E.join)((0,ne.homedir)(),".claude-mem"),e=(0,E.join)(r,"settings.json");try{if((0,D.existsSync)(e)){let t=JSON.parse((0,D.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var h=jt(),y=process.env.CLAUDE_CONFIG_DIR||(0,E.join)((0,ne.homedir)(),".claude"),Os=(0,E.join)(y,"plugins","marketplaces","thedotmack"),Xt=(0,E.join)(h,"archives"),Bt=(0,E.join)(h,"logs"),Wt=(0,E.join)(h,"trash"),Yt=(0,E.join)(h,"backups"),qt=(0,E.join)(h,"modes"),Rs=(0,E.join)(h,"settings.json"),Ae=(0,E.join)(h,"claude-mem.db"),Vt=(0,E.join)(h,"vector-db"),Ce=(0,E.join)(h,"observer-sessions"),oe=(0,E.basename)(Ce),hs=(0,E.join)(y,"settings.json"),As=(0,E.join)(y,"commands"),Cs=(0,E.join)(y,"CLAUDE.md");function Ne(r){(0,D.mkdirSync)(r,{recursive:!0})}function Ie(){return(0,E.join)(Gt(),"..")}var x={dataDir:()=>h,workerPid:()=>(0,E.join)(h,"worker.pid"),serverBetaPid:()=>(0,E.join)(h,".server-beta.pid"),serverBetaPort:()=>(0,E.join)(h,".server-beta.port"),serverBetaRuntime:()=>(0,E.join)(h,".server-beta.runtime.json"),settings:()=>(0,E.join)(h,"settings.json"),database:()=>(0,E.join)(h,"claude-mem.db"),chroma:()=>(0,E.join)(h,"chroma"),combinedCerts:()=>(0,E.join)(h,"combined_certs.pem"),transcriptsConfig:()=>(0,E.join)(h,"transcript-watch.json"),transcriptsState:()=>(0,E.join)(h,"transcript-watch-state.json"),corpora:()=>(0,E.join)(h,"corpora"),supervisorRegistry:()=>(0,E.join)(h,"supervisor.json"),envFile:()=>(0,E.join)(h,".env"),logsDir:()=>Bt,archives:()=>Xt,trash:()=>Wt,backups:()=>Yt,modes:()=>qt,vectorDb:()=>Vt,observerSessions:()=>Ce};var Ue=require("crypto");var Me=require("os"),De=U(require("path"),1),ye=require("child_process");var W=require("fs"),B=U(require("path"),1);var w={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Le(r){let e=B.default.join(r,".git"),t;try{t=(0,W.statSync)(e)}catch(c){return c instanceof Error&&c.code!=="ENOENT"&&u.warn("GIT","Unexpected error checking .git",{error:c instanceof Error?c.message:String(c)}),w}if(!t.isFile())return w;let s;try{s=(0,W.readFileSync)(e,"utf-8").trim()}catch(c){return u.warn("GIT","Failed to read .git file",{error:c instanceof Error?c.message:String(c)}),w}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return w;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return w;let a=i[1],d=B.default.basename(r),p=B.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:p}}function ve(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,Me.homedir)()):r}function Kt(r){try{return(0,ye.execFileSync)("git",["rev-parse","--show-toplevel"],{cwd:r,encoding:"utf-8",stdio:["ignore","pipe","ignore"]}).trim()||null}catch{return null}}function Jt(r){if(!r||r.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=ve(r),s=Kt(e)??e,n=De.default.basename(s);if(n===""){if(process.platform==="win32"){let i=r.match(/^([A-Z]):\\/i);if(i){let d=`drive-${i[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:d}),d}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return n}function ie(r){let e=Jt(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=ve(r),s=Le(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function Y(r,e,t){return(0,Ue.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ae(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var C="claude";function Qt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function v(r){if(!r)return C;let e=Qt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:C}function xe(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function we(r,e,t,s){let n=Date.now()-s;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(e,t,n)??void 0}function zt(r,e){return{customTitle:r,platformSource:e?v(e):void 0}}var q=class{db;constructor(e=Ae){e instanceof de.Database?this.db=e:(e!==":memory:"&&Ne(h),this.db=new de.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.ensureDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn()}ensureDeadPendingMessagesColumns(){let e=this.db.query("PRAGMA table_info(pending_messages)").all(),t=new Set(e.map(n=>n.name)),s=[{name:"retry_count",ddl:"ALTER TABLE pending_messages ADD COLUMN retry_count INTEGER NOT NULL DEFAULT 0"},{name:"failed_at_epoch",ddl:"ALTER TABLE pending_messages ADD COLUMN failed_at_epoch INTEGER"},{name:"completed_at_epoch",ddl:"ALTER TABLE pending_messages ADD COLUMN completed_at_epoch INTEGER"}];for(let{name:n,ddl:o}of s)if(!t.has(n))try{this.db.run(o),u.debug("DB",`Restored ${n} column on pending_messages`)}catch(i){u.warn("DB",`Failed to restore ${n} column on pending_messages`,{},i instanceof Error?i:new Error(String(i)))}}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getAllProjects(e){let t=e?v(e):void 0,s=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[oe];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(C,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(oe),t=[],s=new Set,n={};for(let i of e){let a=v(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=xe(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e){return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(e)}findRecentDuplicateUserPrompt(e,t,s){return we(this.db,e,t,s)}getRecentSessionsWithStatus(e,t=3){return this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,p=s==="relevance",c=p?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,g=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),m=[...e],f=[];if(o&&(f.push("project = ?"),m.push(o)),i)if(Array.isArray(i)){let T=i.map(()=>"?").join(",");f.push(`type IN (${T})`),m.push(...i)}else f.push("type = ?"),m.push(i);if(a){let T=Array.isArray(a)?a:[a],A=T.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");m.push(...T),f.push(`(${A.join(" OR ")})`)}if(d){let T=Array.isArray(d)?d:[d],A=T.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");T.forEach(L=>{m.push(`%${L}%`,`%${L}%`)}),f.push(`(${A.join(" OR ")})`)}let O=f.length>0?`WHERE id IN (${l}) AND ${f.join(" AND ")}`:`WHERE id IN (${l})`,R=this.db.prepare(`
      SELECT *
      FROM observations
      ${O}
      ${c}
      ${g}
    `).all(...m);if(!p)return R;let b=new Map(R.map(T=>[T.id,T]));return e.map(T=>b.get(T)).filter(T=>!!T)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=zt(n,o),p=d.platformSource??C,c=this.db.prepare(`
    ...
    `).get(e);if(c){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let l=c.platform_source?.trim()?v(c.platform_source):void 0;if(!l)this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),p=new Date(d).toISOString(),c=Y(e,s.title,s.narrative),l=this.db.prepare(`
    ...
    `).get(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,c,p,d,a||null,s.metadata??null);if(l)return{id:l.id,createdAtEpoch:l.created_at_epoch};let m=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,c);if(!m)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${c}`);return{id:m.id,createdAtEpoch:m.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),c=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(c.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let p=a??Date.now(),c=new Date(p).toISOString();return this.db.transaction(()=>{let l=[],m=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),f=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let R of s){let b=Y(e,R.title,R.narrative),T=m.get(e,t,R.type,R.title,R.subtitle,JSON.stringify(R.facts),R.narrative,JSON.stringify(R.concepts),JSON.stringify(R.files_read),JSON.stringify(R.files_modified),o||null,i,R.agent_type??null,R.agent_id??null,b,c,p,d||null);if(T){l.push(T.id);continue}let A=f.get(e,b);if(!A)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${b}`);l.push(A.id)}let O=null,S=null;if(n){let R=this.db.prepare(`
          SELECT MAX(created_at_epoch) as max_epoch
          FROM observations WHERE memory_session_id = ?
        `).get(e);S=Math.max(p,(R?.max_epoch??0)+1);let b=new Date(S).toISOString(),A=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,b,S);O=Number(A.lastInsertRowid)}return{observationIds:l,summaryId:O,createdAtEpoch:p}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,p,c){let g=p??Date.now(),l=new Date(g).toISOString();return this.db.transaction(()=>{let f=[],O=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let A of s){let L=Y(e,A.title,A.narrative),j=O.get(e,t,A.type,A.title,A.subtitle,JSON.stringify(A.facts),A.narrative,JSON.stringify(A.concepts),JSON.stringify(A.files_read),JSON.stringify(A.files_modified),a||null,d,A.agent_type??null,A.agent_id??null,L,l,g,c||null);if(j){f.push(j.id);continue}let ee=S.get(e,L);if(!ee)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${L}`);f.push(ee.id)}let R;if(n){let A=this.db.prepare(`
          SELECT MAX(created_at_epoch) as max_epoch
          FROM observations WHERE memory_session_id = ?
        `).get(e),L=Math.max(g,(A?.max_epoch??0)+1),j=new Date(L).toISOString(),yt=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,j,L);R=Number(yt.lastInsertRowid)}if(this.db.prepare(`
        DELETE FROM pending_messages
        WHERE id = ? AND status = 'processing'
      `).run(o).changes!==1)throw new Error(`storeObservationsAndMarkComplete: failed to complete pending message ${o}`);return{observationIds:f,summaryId:R,createdAtEpoch:g}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",p=e.map(()=>"?").join(","),c=[...e],g=o?`WHERE id IN (${p}) AND project = ?`:`WHERE id IN (${p})`;o&&c.push(o);let m=this.db.prepare(`
      SELECT * FROM session_summaries
      ${g}
      ${a}
      ${d}
    `).all(...c);if(!i)return m;let f=new Map(m.map(O=>[O.id,O]));return e.map(O=>f.get(O)).filter(O=>!!O)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",p=e.map(()=>"?").join(","),c=[...e],g=o?"AND s.project = ?":"";o&&c.push(o);let m=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(...c);if(!i)return m;let f=new Map(m.map(O=>[O.id,O]));return e.map(O=>f.get(O)).filter(O=>!!O)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,p;if(e!==null){let S=`
      ...
      `,R=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let b=this.db.prepare(S).all(e,...a,s+1),T=this.db.prepare(R).all(e,...a,n+1);if(b.length===0&&T.length===0)return{observations:[],sessions:[],prompts:[]};d=b.length>0?b[b.length-1].created_at_epoch:t,p=T.length>0?T[T.length-1].created_at_epoch:t}catch(b){return b instanceof Error?u.error("DB","Error getting boundary observations",{project:o},b):u.error("DB","Error getting boundary observations with non-Error",{},new Error(String(b))),{observations:[],sessions:[],prompts:[]}}}else{let S=`
    ...
    `,m=this.db.prepare(c).all(d,p,...a),f=this.db.prepare(g).all(d,p,...a),O=this.db.prepare(l).all(d,p,...a);return{observations:m,sessions:f.map(S=>({id:S.id,memory_session_id:S.memory_session_id,project:S.project,request:S.request,completed:S.completed,next_steps:S.next_steps,created_at:S.created_at,created_at_epoch:S.created_at_epoch})),prompts:O.map(S=>({id:S.id,content_session_id:S.content_session_id,prompt_number:S.prompt_number,prompt_text:S.prompt_text,project:S.project,created_at:S.created_at,created_at_epoch:S.created_at_epoch}))}}getPromptById(e){return this.db.prepare(`
      SELECT
        p.id,
  ...
  `).all(e,e,...s,...o,t.totalObservationCount)}function Ee(r,e,t){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+ce)}function $e(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
...
`}function ft(r,e,t,s){let n=[];return s?n.push(...ot(r)):n.push(...We(r)),s?n.push(...it()):n.push(...Ye()),s?n.push(...at()):n.push(...qe()),s?n.push(...dt()):n.push(...Ve()),K(t)&&(s?n.push(..._t(e,t)):n.push(...Ke(e,t))),n}var fe=U(require("path"),1);function Z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Se(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function be(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function bt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function St(r,e){return fe.default.isAbsolute(r)?fe.default.relative(e,r):r}function Ot(r,e,t){let s=Z(r);if(s.length>0)return St(s[0],e);if(t){let n=Z(t);if(n.length>0)return St(n[0],e)}return"General"}function os(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=bt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Rt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Z(r.facts).join(`
`):null}function is(r,e,t,s){let n=[];n.push(...Je(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Se(a.displayTime);n.push(...et(a,d))}else{let a=i.data,d=be(a.created_at),c=d!==o?d:"";if(o=d,t.has(a.id)){let l=Rt(a,s);n.push(...Ze(a,c,l,s))}else n.push(ze(a,c,s))}return n}function as(r,e,t,s,n){let o=[];o.push(...ut(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let p=d.data,c=Se(p.displayTime);o.push(...lt(p,c))}else{let p=d.data,c=Ot(p.files_modified,n,p.files_read),g=be(p.created_at),l=g!==a;a=g;let m=t.has(p.id);if(c!==i&&(o.push(...ct(c)),i=c),m){let f=Rt(p,s);o.push(...mt(p,g,l,f,s))}else o.push(pt(p,g,l,s))}return o.push(""),o}function ds(r,e,t,s,n,o){return o?as(r,e,t,s,n):is(r,e,t,s)}function ht(r,e,t,s,n){let o=[],i=os(r);for(let[a,d]of i)o.push(...ds(a,d,e,t,s,n));return o}function At(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Ct(r,e){let t=[];return e?(t.push(...G("Investigated",r.investigated,_.blue)),t.push(...G("Learned",r.learned,_.yellow)),t.push(...G("Completed",r.completed,_.green)),t.push(...G("Next Steps",r.next_steps,_.magenta))):(t.push(...H("Investigated",r.investigated)),t.push(...H("Learned",r.learned)),t.push(...H("Completed",r.completed)),t.push(...H("Next Steps",r.next_steps))),t}function Nt(r,e){return e?Et(r):tt(r)}function It(r,e,t){return!K(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?gt(r.totalDiscoveryTokens,r.totalReadTokens):st(r.totalDiscoveryTokens,r.totalReadTokens)}var _s=Lt.default.join((0,Mt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function us(){try{return new q}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Dt.unlinkSync)(_s)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function cs(r,e){return e?Tt(r):rt(r)}function ps(r,e,t,s,n,o,i){let a=[],d=me(e);a.push(...ft(r,d,s,i));let p=t.slice(0,s.sessionCount),c=je(p,t),g=Te(e,c),l=Xe(e,s.fullObservationCount);a.push(...ht(g,l,s,n,i));let m=t[0],f=e[0];At(s,m,f)&&a.push(...Ct(m,i));let O=ge(e,s,o,n);return a.push(...Nt(O,i)),a.push(...It(d,s,i)),a.join(`
`).trimEnd()}async function Oe(r,e=!1){let t=ue(),s=r?.cwd??process.cwd(),n=ie(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=us();if(!a)return"";try{let d=o.length>1?$e(a,o,t):le(a,i,t),p=o.length>1?He(a,o,t):Ee(a,i,t);return d.length===0&&p.length===0?cs(i,e):ps(i,d,p,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
