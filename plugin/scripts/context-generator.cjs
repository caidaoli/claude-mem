"use strict";var Lt=Object.create;var X=Object.defineProperty;var Mt=Object.getOwnPropertyDescriptor;var Dt=Object.getOwnPropertyNames;var vt=Object.getPrototypeOf,yt=Object.prototype.hasOwnProperty;var Ut=(r,e)=>{for(var t in e)X(r,t,{get:e[t],enumerable:!0})},Oe=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Dt(e))!yt.call(r,n)&&n!==t&&X(r,n,{get:()=>e[n],enumerable:!(s=Mt(e,n))||s.enumerable});return r};var U=(r,e,t)=>(t=r!=null?Lt(vt(r)):{},Oe(e||!r||!r.__esModule?X(t,"default",{value:r,enumerable:!0}):t,r)),xt=r=>Oe(X({},"__esModule",{value:!0}),r);var as={};Ut(as,{generateContext:()=>be});module.exports=xt(as);var Rt=U(require("path"),1),Ct=require("os"),Nt=require("fs");var ae=require("bun:sqlite");var g=require("path"),re=require("os"),D=require("fs");var M=require("fs"),he=require("path");var te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(te||{}),se=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,M.existsSync)(e)||(0,M.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,he.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,M.existsSync)(e)){let t=(0,M.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=te[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{c=" "+this.formatData(o)}else c=" "+this.formatData(o);let E="";if(n){let{sessionId:l,memorySessionId:f,correlationId:O,...S}=n;Object.keys(S).length>0&&(E=` {${Object.entries(S).map(([b,T])=>`${b}=${T}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${m}${s}${E}${c}`;if(this.logFilePath)try{(0,M.appendFileSync)(this.logFilePath,p+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),c=m?`${m[1].split("/").pop()}:${m[2]}`:"unknown",E={...s,location:c};return this.warn(e,`[HAPPY-PATH] ${t}`,E,n),o}},u=new se;function wt(){let r=process.argv[1];return r?(0,g.dirname)(r):process.cwd()}function kt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,g.join)((0,re.homedir)(),".claude-mem"),e=(0,g.join)(r,"settings.json");try{if((0,D.existsSync)(e)){let t=JSON.parse((0,D.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var R=kt(),v=process.env.CLAUDE_CONFIG_DIR||(0,g.join)((0,re.homedir)(),".claude"),ls=(0,g.join)(v,"plugins","marketplaces","thedotmack"),Ft=(0,g.join)(R,"archives"),$t=(0,g.join)(R,"logs"),Pt=(0,g.join)(R,"trash"),Ht=(0,g.join)(R,"backups"),Gt=(0,g.join)(R,"modes"),ps=(0,g.join)(R,"settings.json"),Ae=(0,g.join)(R,"claude-mem.db"),Xt=(0,g.join)(R,"vector-db"),Re=(0,g.join)(R,"observer-sessions"),ne=(0,g.basename)(Re),Es=(0,g.join)(v,"settings.json"),gs=(0,g.join)(v,"commands"),Ts=(0,g.join)(v,"CLAUDE.md");function Ce(r){(0,D.mkdirSync)(r,{recursive:!0})}function Ne(){return(0,g.join)(wt(),"..")}var x={dataDir:()=>R,workerPid:()=>(0,g.join)(R,"worker.pid"),settings:()=>(0,g.join)(R,"settings.json"),database:()=>(0,g.join)(R,"claude-mem.db"),chroma:()=>(0,g.join)(R,"chroma"),combinedCerts:()=>(0,g.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,g.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,g.join)(R,"transcript-watch-state.json"),corpora:()=>(0,g.join)(R,"corpora"),supervisorRegistry:()=>(0,g.join)(R,"supervisor.json"),envFile:()=>(0,g.join)(R,".env"),logsDir:()=>$t,archives:()=>Ft,trash:()=>Pt,backups:()=>Ht,modes:()=>Gt,vectorDb:()=>Xt,observerSessions:()=>Re};var ve=require("crypto");var Le=require("os"),Me=U(require("path"),1);var B=require("fs"),j=U(require("path"),1),w={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Ie(r){let e=j.default.join(r,".git"),t;try{t=(0,B.statSync)(e)}catch(c){return c instanceof Error&&c.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",c),w}if(!t.isFile())return w;let s;try{s=(0,B.readFileSync)(e,"utf-8").trim()}catch(c){return console.warn("[worktree] Failed to read .git file:",c instanceof Error?c.message:String(c)),w}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return w;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return w;let a=i[1],d=j.default.basename(r),m=j.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:m}}function De(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,Le.homedir)()):r}function jt(r){if(!r||r.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=De(r),t=Me.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function oe(r){let e=jt(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=De(r),s=Ie(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function W(r,e,t){return(0,ve.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ie(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var C="claude";function Bt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return C;let e=Bt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:C}function ye(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Wt(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var q=class{db;constructor(e=Ae){e instanceof ae.Database?this.db=e:(e!==":memory:"&&Ce(R),this.db=new ae.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.ensureDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn()}ensureDeadPendingMessagesColumns(){let e=this.db.query("PRAGMA table_info(pending_messages)").all(),t=new Set(e.map(n=>n.name)),s=[{name:"retry_count",ddl:"ALTER TABLE pending_messages ADD COLUMN retry_count INTEGER NOT NULL DEFAULT 0"},{name:"failed_at_epoch",ddl:"ALTER TABLE pending_messages ADD COLUMN failed_at_epoch INTEGER"},{name:"completed_at_epoch",ddl:"ALTER TABLE pending_messages ADD COLUMN completed_at_epoch INTEGER"}];for(let{name:n,ddl:o}of s)if(!t.has(n))try{this.db.run(o),u.debug("DB",`Restored ${n} column on pending_messages`)}catch(i){u.warn("DB",`Failed to restore ${n} column on pending_messages`,{},i instanceof Error?i:new Error(String(i)))}}initializeSchema(){this.db.run(`
    ...
    `).run(t,e)}markSessionCompleted(e){let t=Date.now(),s=new Date(t).toISOString();this.db.prepare(`
      ...
      WHERE id = ?
    `).run(s,t,e)}markSessionCompleted(e,t=Date.now()){let s=new Date(t).toISOString();this.db.prepare(`
      UPDATE sdk_sessions
      SET
        status = 'completed',
        completed_at = ?,
    ...
    `).run(e)}isSessionCompleted(e){return this.db.prepare(`
      ...
      WHERE id = ?
      LIMIT 1
    `).get(e)?.status==="completed"}ensureMemorySessionIdRegistered(e,t){let s=this.db.prepare(`
    ...
    `).all(e)}getAllProjects(e){let t=e?y(e):void 0,s=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[ne];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(C,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,m=s==="relevance",c=m?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,E=n?`LIMIT ${n}`:"",p=e.map(()=>"?").join(","),l=[...e],f=[];if(o&&(f.push("project = ?"),l.push(o)),i)if(Array.isArray(i)){let T=i.map(()=>"?").join(",");f.push(`type IN (${T})`),l.push(...i)}else f.push("type = ?"),l.push(i);if(a){let T=Array.isArray(a)?a:[a],A=T.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");l.push(...T),f.push(`(${A.join(" OR ")})`)}if(d){let T=Array.isArray(d)?d:[d],A=T.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");T.forEach(L=>{l.push(`%${L}%`,`%${L}%`)}),f.push(`(${A.join(" OR ")})`)}let O=f.length>0?`WHERE id IN (${p}) AND ${f.join(" AND ")}`:`WHERE id IN (${p})`,h=this.db.prepare(`
      SELECT *
      FROM observations
      ${O}
      ${c}
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Wt(n,o),m=d.platformSource??C,c=this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),m=new Date(d).toISOString(),c=W(e,s.title,s.narrative),p=this.db.prepare(`
    ...
    `).get(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,c,m,d,a||null,s.metadata??null);if(p)return{id:p.id,createdAtEpoch:p.created_at_epoch};let l=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,c);if(!l)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${c}`);return{id:l.id,createdAtEpoch:l.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),c=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(c.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let m=a??Date.now(),c=new Date(m).toISOString();return this.db.transaction(()=>{let p=[],l=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),f=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let h of s){let b=W(e,h.title,h.narrative),T=l.get(e,t,h.type,h.title,h.subtitle,JSON.stringify(h.facts),h.narrative,JSON.stringify(h.concepts),JSON.stringify(h.files_read),JSON.stringify(h.files_modified),o||null,i,h.agent_type??null,h.agent_id??null,b,c,m,d||null);if(T){p.push(T.id);continue}let A=f.get(e,b);if(!A)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${b}`);p.push(A.id)}let O=null,S=null;if(n){let h=this.db.prepare(`
          SELECT MAX(created_at_epoch) as max_epoch
          FROM observations WHERE memory_session_id = ?
        `).get(e);S=Math.max(m,(h?.max_epoch??0)+1);let b=new Date(S).toISOString(),A=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,b,S);O=Number(A.lastInsertRowid)}return{observationIds:p,summaryId:O,createdAtEpoch:m}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,m,c){let E=m??Date.now(),p=new Date(E).toISOString();return this.db.transaction(()=>{let f=[],O=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let A of s){let L=W(e,A.title,A.narrative),G=O.get(e,t,A.type,A.title,A.subtitle,JSON.stringify(A.facts),A.narrative,JSON.stringify(A.concepts),JSON.stringify(A.files_read),JSON.stringify(A.files_modified),a||null,d,A.agent_type??null,A.agent_id??null,L,p,E,c||null);if(G){f.push(G.id);continue}let ee=S.get(e,L);if(!ee)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${L}`);f.push(ee.id)}let h;if(n){let A=this.db.prepare(`
          SELECT MAX(created_at_epoch) as max_epoch
          FROM observations WHERE memory_session_id = ?
        `).get(e),L=Math.max(E,(A?.max_epoch??0)+1),G=new Date(L).toISOString(),It=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,G,L);h=Number(It.lastInsertRowid)}if(this.db.prepare(`
        DELETE FROM pending_messages
        WHERE id = ? AND status = 'processing'
      `).run(o).changes!==1)throw new Error(`storeObservationsAndMarkComplete: failed to complete pending message ${o}`);return{observationIds:f,summaryId:h,createdAtEpoch:E}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),c=[...e],E=o?`WHERE id IN (${m}) AND project = ?`:`WHERE id IN (${m})`;o&&c.push(o);let l=this.db.prepare(`
      SELECT * FROM session_summaries
      ${E}
      ${a}
      ${d}
    `).all(...c);if(!i)return l;let f=new Map(l.map(O=>[O.id,O]));return e.map(O=>f.get(O)).filter(O=>!!O)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),c=[...e],E=o?"AND s.project = ?":"";o&&c.push(o);let l=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
  ...
  `).all(e,e,...s,...o,t.totalObservationCount)}function pe(r,e,t){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+ue)}function ke(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
...
`}function pt(r,e,t,s){let n=[];return s?n.push(...tt(r)):n.push(...Ge(r)),s?n.push(...st()):n.push(...Xe()),s?n.push(...rt()):n.push(...je()),s?n.push(...nt()):n.push(...Be()),V(t)&&(s?n.push(...ot(e,t)):n.push(...We(e,t))),n}var Te=U(require("path"),1);function Z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function fe(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Se(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function gt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Et(r,e){return Te.default.isAbsolute(r)?Te.default.relative(e,r):r}function Tt(r,e,t){let s=Z(r);if(s.length>0)return Et(s[0],e);if(t){let n=Z(t);if(n.length>0)return Et(n[0],e)}return"General"}function Zt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=gt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function ft(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Z(r.facts).join(`
`):null}function es(r,e,t,s){let n=[];n.push(...qe(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=fe(a.displayTime);n.push(...Je(a,d))}else{let a=i.data,d=Se(a.created_at),c=d!==o?d:"";if(o=d,t.has(a.id)){let p=ft(a,s);n.push(...Ve(a,c,p,s))}else n.push(Ke(a,c,s))}return n}function ts(r,e,t,s,n){let o=[];o.push(...it(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let m=d.data,c=fe(m.displayTime);o.push(...ut(m,c))}else{let m=d.data,c=Tt(m.files_modified,n,m.files_read),E=Se(m.created_at),p=E!==a;a=E;let l=t.has(m.id);if(c!==i&&(o.push(...at(c)),i=c),l){let f=ft(m,s);o.push(..._t(m,E,p,f,s))}else o.push(dt(m,E,p,s))}return o.push(""),o}function ss(r,e,t,s,n,o){return o?ts(r,e,t,s,n):es(r,e,t,s)}function St(r,e,t,s,n){let o=[],i=Zt(r);for(let[a,d]of i)o.push(...ss(a,d,e,t,s,n));return o}function bt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Ot(r,e){let t=[];return e?(t.push(...H("Investigated",r.investigated,_.blue)),t.push(...H("Learned",r.learned,_.yellow)),t.push(...H("Completed",r.completed,_.green)),t.push(...H("Next Steps",r.next_steps,_.magenta))):(t.push(...P("Investigated",r.investigated)),t.push(...P("Learned",r.learned)),t.push(...P("Completed",r.completed)),t.push(...P("Next Steps",r.next_steps))),t}function ht(r,e){return e?ct(r):Qe(r)}function At(r,e,t){return!V(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?mt(r.totalDiscoveryTokens,r.totalReadTokens):ze(r.totalDiscoveryTokens,r.totalReadTokens)}var rs=Rt.default.join((0,Ct.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function ns(){try{return new q}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Nt.unlinkSync)(rs)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function os(r,e){return e?lt(r):Ze(r)}function is(r,e,t,s,n,o,i){let a=[],d=me(e);a.push(...pt(r,d,s,i));let m=t.slice(0,s.sessionCount),c=$e(m,t),E=ge(e,c),p=Pe(e,s.fullObservationCount);a.push(...St(E,p,s,n,i));let l=t[0],f=e[0];bt(s,l,f)&&a.push(...Ot(l,i));let O=Ee(e,s,o,n);return a.push(...ht(O,i)),a.push(...At(d,s,i)),a.join(`
`).trimEnd()}async function be(r,e=!1){let t=_e(),s=r?.cwd??process.cwd(),n=oe(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=ns();if(!a)return"";try{let d=o.length>1?ke(a,o,t):le(a,i,t),m=o.length>1?Fe(a,o,t):pe(a,i,t);return d.length===0&&m.length===0?os(i,e):is(i,d,m,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
