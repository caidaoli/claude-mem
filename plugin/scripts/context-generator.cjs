"use strict";var Et=Object.create;var x=Object.defineProperty;var Tt=Object.getOwnPropertyDescriptor;var gt=Object.getOwnPropertyNames;var ft=Object.getPrototypeOf,St=Object.prototype.hasOwnProperty;var bt=(r,e)=>{for(var t in e)x(r,t,{get:e[t],enumerable:!0})},ae=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of gt(e))!St.call(r,n)&&n!==t&&x(r,n,{get:()=>e[n],enumerable:!(s=Tt(e,n))||s.enumerable});return r};var L=(r,e,t)=>(t=r!=null?Et(ft(r)):{},ae(e||!r||!r.__esModule?x(t,"default",{value:r,enumerable:!0}):t,r)),ht=r=>ae(x({},"__esModule",{value:!0}),r);var kt={};bt(kt,{generateContext:()=>oe});module.exports=ht(kt);var pt=L(require("path"),1),mt=require("os"),ut=require("fs");var le=require("bun:sqlite");var b=require("path"),K=require("os"),k=require("fs");var N=require("fs"),v=require("path"),_e=require("os"),q=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(q||{}),de=(0,v.join)((0,_e.homedir)(),".claude-mem"),V=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(de,"logs");(0,N.existsSync)(e)||(0,N.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(de,"settings.json");if((0,N.existsSync)(e)){let t=(0,N.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=q[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):m=" "+this.formatData(o));let l="";if(n){let{sessionId:E,memorySessionId:h,correlationId:S,...u}=n;Object.keys(u).length>0&&(l=` {${Object.entries(u).map(([f,O])=>`${f}=${O}`).join(", ")}}`)}let T=`[${i}] [${a}] [${_}] ${c}${s}${l}${m}`;if(this.logFilePath)try{(0,N.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},p=new V;function Ot(){let r=process.argv[1];return r?(0,b.dirname)(r):process.cwd()}function Rt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,b.join)((0,K.homedir)(),".claude-mem"),e=(0,b.join)(r,"settings.json");try{if((0,k.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var C=Rt(),I=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,K.homedir)(),".claude"),Xt=(0,b.join)(I,"plugins","marketplaces","thedotmack"),jt=(0,b.join)(C,"archives"),Gt=(0,b.join)(C,"logs"),Ht=(0,b.join)(C,"trash"),Bt=(0,b.join)(C,"backups"),Wt=(0,b.join)(C,"modes"),Yt=(0,b.join)(C,"settings.json"),ce=(0,b.join)(C,"claude-mem.db"),qt=(0,b.join)(C,"vector-db"),Vt=(0,b.join)(C,"observer-sessions"),Kt=(0,b.join)(I,"settings.json"),Jt=(0,b.join)(I,"commands"),Qt=(0,b.join)(I,"CLAUDE.md");function pe(r){(0,k.mkdirSync)(r,{recursive:!0})}function me(){return(0,b.join)(Ot(),"..")}var ue=require("crypto");var Ct=3e4;function w(r,e,t){return(0,ue.createHash)("sha256").update((r||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function $(r,e,t){let s=t-Ct;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var F=class{db;constructor(e=ce){e!==":memory:"&&pe(C),this.db=new le.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:_}=t,c=s==="date_asc"?"ASC":"DESC",m=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),T=[...e],E=[];if(o&&(E.push("project = ?"),T.push(o)),i)if(Array.isArray(i)){let u=i.map(()=>"?").join(",");E.push(`type IN (${u})`),T.push(...i)}else E.push("type = ?"),T.push(i);if(a){let u=Array.isArray(a)?a:[a],g=u.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");T.push(...u),E.push(`(${g.join(" OR ")})`)}if(_){let u=Array.isArray(_)?_:[_],g=u.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");u.forEach(f=>{T.push(`%${f}%`,`%${f}%`)}),E.push(`(${g.join(" OR ")})`)}let h=E.length>0?`WHERE id IN (${l}) AND ${E.join(" AND ")}`:`WHERE id IN (${l})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${h}
    ...
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,c,_,a);return{id:Number(T.lastInsertRowid),createdAtEpoch:a}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),_=new Date(a).toISOString(),m=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,_,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let _=a??Date.now(),c=new Date(_).toISOString();return this.db.transaction(()=>{let l=[],T=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let S of s){let u=w(e,S.title,S.narrative),g=$(this.db,u,_);if(g){l.push(g.id);continue}let f=T.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),o||null,i,u,c,_);l.push(Number(f.lastInsertRowid))}let E=null,h=null;if(n){let S=this.db.prepare(`
          SELECT MAX(created_at_epoch) as max_epoch
          FROM observations WHERE memory_session_id = ?
        `).get(e);h=Math.max(_,(S?.max_epoch??0)+1);let u=new Date(h).toISOString(),f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,u,h);E=Number(f.lastInsertRowid)}return{observationIds:l,summaryId:E,createdAtEpoch:_}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,_=0,c){let m=c??Date.now(),l=new Date(m).toISOString();return this.db.transaction(()=>{let E=[],h=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let g of s){let f=w(e,g.title,g.narrative),O=$(this.db,f,m);if(O){E.push(O.id);continue}let ie=h.run(e,t,g.type,g.title,g.subtitle,JSON.stringify(g.facts),g.narrative,JSON.stringify(g.concepts),JSON.stringify(g.files_read),JSON.stringify(g.files_modified),a||null,_,f,l,m);E.push(Number(ie.lastInsertRowid))}let S;if(n){let g=this.db.prepare(`
          SELECT MAX(created_at_epoch) as max_epoch
          FROM observations WHERE memory_session_id = ?
        `).get(e),f=Math.max(m,(g?.max_epoch??0)+1),O=new Date(f).toISOString(),lt=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,_,O,f);S=Number(lt.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(m,o),{observationIds:E,summaryId:S,createdAtEpoch:m}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",_=e.map(()=>"?").join(","),c=[...e],m=o?`WHERE id IN (${_}) AND project = ?`:`WHERE id IN (${_})`;return o&&c.push(o),this.db.prepare(`
    ...
    `).all(...c)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],_,c;if(e!==null){let u=`
      ...
      `,g=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let f=this.db.prepare(u).all(e,...a,s+1),O=this.db.prepare(g).all(e,...a,n+1);if(f.length===0&&O.length===0)return{observations:[],sessions:[],prompts:[]};_=f.length>0?f[f.length-1].created_at_epoch:t,c=O.length>0?O[O.length-1].created_at_epoch:t}catch(f){return p.error("DB","Error getting boundary observations",void 0,{error:f,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let u=`
      ...
      `,g=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let f=this.db.prepare(u).all(t,...a,s),O=this.db.prepare(g).all(t,...a,n+1);if(f.length===0&&O.length===0)return{observations:[],sessions:[],prompts:[]};_=f.length>0?f[f.length-1].created_at_epoch:t,c=O.length>0?O[O.length-1].created_at_epoch:t}catch(f){return p.error("DB","Error getting boundary timestamps",void 0,{error:f,project:o}),{observations:[],sessions:[],prompts:[]}}}let m=`
      SELECT *
      FROM observations
...
`}function et(r,e,t,s){let n=[];return s?n.push(...je(r)):n.push(...Ie(r)),s?n.push(...Ge()):n.push(...Me()),s?n.push(...He()):n.push(...Le()),s?n.push(...Be()):n.push(...ve()),G(t)&&(s?n.push(...We(e,t)):n.push(...ye(e,t))),n}var ne=L(require("path"),1);function Y(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return p.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function st(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function rt(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function nt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function tt(r,e){return ne.default.isAbsolute(r)?ne.default.relative(e,r):r}function ot(r,e,t){let s=Y(r);if(s.length>0)return tt(s[0],e);if(t){let n=Y(t);if(n.length>0)return tt(n[0],e)}return"General"}function Mt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=nt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Lt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Y(r.facts).join(`
`):null}function vt(r,e,t,s,n,o){let i=[];o?i.push(...Ye(r)):i.push(...De(r));let a=null,_="",c=!1;for(let m of e)if(m.type==="summary"){c&&(i.push(""),c=!1,a=null,_="");let l=m.data,T=st(l.displayTime);o?i.push(...Je(l,T)):i.push(...we(l,T))}else{let l=m.data,T=ot(l.files_modified,n,l.files_read),E=rt(l.created_at),h=E!==_,S=h?E:"";_=E;let u=t.has(l.id);if(T!==a&&(c&&i.push(""),o?i.push(...qe(T)):i.push(...Ue(T)),a=T,c=!0),u){let g=Lt(l,s);o?i.push(...Ke(l,E,h,g,s)):(c&&!o&&(i.push(""),c=!1),i.push(...ke(l,S,g,s)),a=null)}else o?i.push(Ve(l,E,h,s)):i.push(xe(l,S,s))}return c&&i.push(""),i}function it(r,e,t,s,n){let o=[],i=Mt(r);for(let[a,_]of i)o.push(...vt(a,_,e,t,s,n));return o}function at(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function dt(r,e){let t=[];return e?(t.push(...U("Investigated",r.investigated,d.blue)),t.push(...U("Learned",r.learned,d.yellow)),t.push(...U("Completed",r.completed,d.green)),t.push(...U("Next Steps",r.next_steps,d.magenta))):(t.push(...D("Investigated",r.investigated)),t.push(...D("Learned",r.learned)),t.push(...D("Completed",r.completed)),t.push(...D("Next Steps",r.next_steps))),t}function _t(r,e){return e?Qe(r):$e(r)}function ct(r,e,t){return!G(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?ze(r.totalDiscoveryTokens,r.totalReadTokens):Fe(r.totalDiscoveryTokens,r.totalReadTokens)}var yt=pt.default.join((0,mt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Dt(){try{return new F}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,ut.unlinkSync)(yt)}catch(e){p.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return p.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Ut(r,e){return e?Ze(r):Pe(r)}function xt(r,e,t,s,n,o,i){let a=[],_=Z(e);a.push(...et(r,_,s,i));let c=t.slice(0,s.sessionCount),m=Ce(c,t),l=re(e,m),T=Ae(e,s.fullObservationCount);a.push(...it(l,T,s,n,i));let E=t[0],h=e[0];at(s,E,h)&&a.push(...dt(E,i));let S=se(e,s,o,n);return a.push(..._t(S,i)),a.push(...ct(_,s,i)),a.join(`
`).trimEnd()}async function oe(r,e=!1){let t=J(),s=r?.cwd??process.cwd(),n=Te(s),o=r?.projects||[n],i=Dt();if(!i)return"";try{let a=o.length>1?Oe(i,o,t):ee(i,n,t),_=o.length>1?Re(i,o,t):te(i,n,t);return a.length===0&&_.length===0?Ut(n,e):xt(n,a,_,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
